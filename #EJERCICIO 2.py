...
try:
    ...
    mensaje_des_bytes = pad(cipher.decrypt(texto_cifrado_bytes), AES.block_size, style="pkcs7")

    #mensaje_des_bytes = pad(cipher.decrypt(texto_cifrado_bytes), AES.block_size, style="X923")
